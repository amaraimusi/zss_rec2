<?php
$this->CrudBase->init(array('model_name'=>'RecCtg'));
...
<div class="cb_func_line">
	...
	<div class="cb_kj_main">
		...
		<?php $this->CrudBase->inputKjMain($kjs,'kj_main','',null,'記録カテゴリ名前、記録カテゴリ日、備考を検索する');?>
	...
	<a href="rec_ctg/front_a?row_limit=10" class="btn btn-info btn-xs" target="blank" >フロント画面</a>
...
<!-- 一覧テーブル -->
<table id="rec_ctg_tbl" border="1"  class="table table-striped table-bordered table-condensed">
