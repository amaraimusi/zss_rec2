...
// 		}
	...
	public function ajax_delete(){
		...
		if($eliminate_flg == 0){
			...
			$this->RecCtg->eliminateFiles($ent['id'], 'img_fn', $ent); // ファイル抹消（他のレコードが保持しているファイルは抹消対象外）
	...
	*/
	...
	public function bulk_reg(){
		...
		$res = $bulkReg->reg('rec_ctgs', $param);
	...
	public function csv_fu(){
		...
		$this->csv_fu_base($this->RecCtg,array('id','rec_ctg_val','rec_ctg_name','rec_ctg_date','rec_ctg_group','rec_ctg_dt','rec_ctg_flg','img_fn','note','sort_no'));
