...
function init(){
	...
	// CBBXS-1023
	// タイトルカテゴリリストJSON
	var title_ctg_id_json = jQuery('#title_ctg_id_json').val();
	var titleCtgIdList = JSON.parse(title_ctg_id_json);
	disFilData['title_ctg_id'] ={'fil_type':'select','option':{'list':titleCtgIdList}};
